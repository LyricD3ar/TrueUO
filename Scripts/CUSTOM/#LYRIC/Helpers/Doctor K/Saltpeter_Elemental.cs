...
{
    [CorpseName("an saltpeter elemental corpse")]
    public class SaltpeterElemental : BaseCreature
    {
        [Constructable]
        public SaltpeterElemental()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a saltpeter elemental";
            Body = 112;
            BaseSoundID = 268;
			Hue = 2199;
        ...
        public SaltpeterElemental(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void GenerateLoot()
        {
            ...
            AddLoot(LootPack.LootItem<Saltpeter>(25));
        }
        ...
        public override bool OnBeforeDeath()
        {
            ...
            foreach (Mobile m in list)
            {
                ...
                {
                    mob.FixedParticles(0x423A, 20, 10, 5044, EffectLayer.Head);
                    mob.PlaySound(0x307);
